...
# </p><!-- <o> --><p><p>  ==>  <!-- <o> --><p>
# </p><p rend="margin-left:1em"><p>  ==>  <p rend="margin-left:1em">
# </p><!-- <o> --><p place="inline"></p><p place="inline">  ==>  </p><!-- <o> --><p place="inline">
# </p><p place="inline" rend="margin-left:1em"></p><p place="inline">  ==>  </p><p place="inline" rend="margin-left:1em">
...
while(<IN>)
{
	...
	s/<\/p><p( rend="margin-left:\-?\d+em">)(${skip}*)(<p\s?.*?)>/$2$3$1/g;
	s/<\/p><p place="inline"( rend="margin-left:\-?\d+em">)(<\/p>)(${skip}*)(<p\s?.*?)>/$2$3$4$1/g;
