...
my $OutputPath = "d:/cbeta.www/download/mobi/cbeta_mobi_2021q1";		# 目地初始目錄, 如果有需要的話. 最後不用加斜線 /
...
sub SearchFile
{
	...
	my $cmd = "\"c:/Users/Heaven/Calibre3.48/Calibre Portable/Calibre/ebook-convert.exe\" $file $outfile --mobi-file-type both";
