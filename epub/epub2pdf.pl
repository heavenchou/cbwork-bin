...
# 參數如下:
# 	ebook-convert.exe $file $outfile --paper-size a4 --pdf-serif-family SimSun
# 	SimSun 字型所產生的檔案比細明體還小, 故選用它.

use utf8;
use Cwd;
use strict;

my $SourcePath = "d:/cbeta.www/download/epub/cbeta_epub_2019q3/cbeta_epub_2019q3";			# 初始目錄, 最後不用加斜線 /
my $OutputPath = "c:/cbwork/bin/epub/pdf";		# 目地初始目錄, 如果有需要的話. 最後不用加斜線 /
