...
my $SourcePath = "d:/cbeta.www/download/epub/cbeta_epub_2020q4";			# 初始目錄, 最後不用加斜線 /
my $OutputPath = "d:/cbeta.www/download/pdf_a4/cbeta_pdf_2020q4";		# 目地初始目錄, 如果有需要的話. 最後不用加斜線 /
...
sub SearchFile
{
	...
	my $cmd = "\"c:/Users/Heaven/Calibre3.48/Calibre Portable/Calibre/ebook-convert.exe\" $file $outfile --paper-size a4 --pdf-serif-family MingLiU --pdf-page-numbers";
